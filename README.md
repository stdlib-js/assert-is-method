...
```javascript
isMethod = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-method@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var isMethod = require( 'path/to/vendor/umd/assert-is-method/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-method@v0.2.1-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/assert-is-method/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/assert-is-method/actions/workflows/test.yml?query=branch:v0.2.1
...
[@stdlib/assert/is-method-in]: https://github.com/stdlib-js/assert-is-method-in/tree/umd
